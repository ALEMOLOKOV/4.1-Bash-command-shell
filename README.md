...
| ------------- | ------------- | ------------- |
| `c`  | a+b  | тип строка, просто выведет все что после знака равно |
| `d`  | 1+2  | вывод аргументов переменных без операции сложения, т.к. нет скобок |
| `e`  | 3  | сумма аргументов, т.к. арифметическая операция указана в скобках |
